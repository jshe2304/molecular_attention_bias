...
class GaussianBasis(nn.Module):
    ...
    def __init__(self, n_heads, n_kernels=128, *args, **kwargs):
        super().__init__()
    ...
    def forward(self, d):
        ...
        gaussians = torch.exp(-0.5 * ((d.unsqueeze(-1) - mu) / sigma) ** 2) / (
            sigma * 2.506628275
        )
